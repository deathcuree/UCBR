...
<title><?php echo isset($title) ? $title . ' | UniverCity Belt Residences' :  'UniverCity Belt Residences' ; ?></title>
  ...
  <div id="header-wrap" class="clr fixed-header">
    <header id="header" class="site-header clr">
      ...
      <div id="logo" class="clr">
        ...
        <h2 id="site-name">
          <a href="<?php echo WEB_ROOT; ?>index.php" title="UniverCity Belt Residences">UniverCity Belt Residences</a>
      ...
      <div id="main-menu" class="menu-main-container">
           ...
           $cur = $accomodation->listOfaccomodation(); 
            ...
            <ul>
              ...
              <li><a href="<?php echo WEB_ROOT; ?>index.php?p=login">Login</a></li> 
            </ul> 
...
<div id="homepage-slider-wrap" class="clr flexslider-container">
    <div id="homepage-slider" class="flexslider">
      <ul class="slides clr">
       <li>
            <img src="<?php echo WEB_ROOT; ?>images/header.jpg" alt="header photo of UCBR">
        </li>
...
$('.dbirth').datetimepicker({
  ...
  //Validates Personal Info
        ...
        if ((a=="First name" || a=="") || (b=="Last name" || b=="") || (c=="City" || c=="") || (d=="Address" || d=="") || (e=="Date of birth" || e=="") || (f=="Zip" || f=="") || (g=="Phone" || g=="")|| (h=="Username" || h=="") || (j=="Password" || j==""))
          {

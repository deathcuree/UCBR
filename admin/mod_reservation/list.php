...
$cur = $mydb->loadResultList();
	...
	<?php 
		if($result->STATUS == 'Confirmed'){ ?>
			...
			<a href="controller.php?action=cancel&id=<?php echo $result->CONFIRMATIONCODE; ?>" class="btn btn-primary btn-xs" ><i class="icon-edit">Cancel</a>
	...
	<?php
		...
		elseif($result->STATUS == 'Checkedout'){ ?>
			<a href="index.php?view=view&code=<?php echo $result->CONFIRMATIONCODE; ?>" class="btn btn-primary btn-xs" ><i class="icon-edit">View</a>
			<a href="controller.php?action=deleteOne&delete=<?php echo $result->CONFIRMATIONCODE; ?>" class="btn btn-danger btn-xs" name="delete" type = "submit" id = "delete" value = "Delete" name="delete"><i class="icon-edit">Delete</a>
